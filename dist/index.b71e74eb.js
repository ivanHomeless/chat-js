...
var _indexScss = require("./scss/index.scss"); // Подключение файла SCSS
 ...
 */ var _isEmpty = require("./utils/mydash/is-empty");
console.log((0, _isEmpty.isEmpty)(null)) // => true
;
console.log((0, _isEmpty.isEmpty)(true)) // => true
;
console.log((0, _isEmpty.isEmpty)(1)) // => true
;
console.log((0, _isEmpty.isEmpty)([
    1,
    2,
    3
])) // => false
...
;
console.log((0, _isEmpty.isEmpty)('123')) // => false
;
console.log((0, _isEmpty.isEmpty)(123)) // => true
;
console.log((0, _isEmpty.isEmpty)('')) // => true
;
console.log((0, _isEmpty.isEmpty)(0)) // => truee
;

},{"./scss/index.scss":"kVb0b","./utils/mydash/is-empty":"jNlSf"}],"kVb0b":[function() {},{}],"jNlSf":[function(require,module,exports,__globalThis) {
